...
public interface ISpectrum : IEquatable<ISpectrum> {
    ...
    static ISpectrum operator +(ISpectrum left, ISpectrum right) => (RGBSpectrum)left + (RGBSpectrum)right;
    ...
    static ISpectrum operator *(ISpectrum left, float right) => left is RGBSpectrum rgb ? rgb * right : throw new NotImplementedException();

...
public static class DoubleExtensions {
    ...
    public static double FromIndex(this long index) {
        if (index < MinIndex || index > MaxIndex) {
            ...
            var bits = index < 0 ? (index - 1) ^ long.MaxValue : index;
    ...
    public static double Next(this double value) => double.IsPositiveInfinity(value)
    ...
    public static double Increment(this double value, ulong amount) {
        var index = value.ToIndex() + (long)amount;
    ...
    public static double Previous(this double value) => double.IsNegativeInfinity(value)
    ...
    public static double TryMakeFinite(this double value) => double.IsFinite(value)
            ? value
            : double.IsPositiveInfinity(value)
                ? double.MaxValue
                : double.IsNegativeInfinity(value) ? double.MinValue : throw new ArgumentException($"{value} can not be made finite.");
}

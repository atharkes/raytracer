...
namespace PathTracer.Pathtracing.SceneDescription {
    ...
    public interface IMaterial {
        ...
        //IDistancePDF? DistancePDF(IRay ray, ISpectrum spectrum, IBoundary boundary);
        ...
        //IPDF<IMaterial>? MaterialPDF(IRay ray, ISpectrum spectrum, IBoundary boundary, float distance);

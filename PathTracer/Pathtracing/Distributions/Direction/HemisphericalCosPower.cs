...
public readonly struct HemisphericalCosPower : IDirectionDistribution, IEquatable<HemisphericalCosPower> {
    ...
    public Normal3 Sample(Random random) {
        /// Compute Height
        var theta = Math.Pow((random.NextDouble() - 0.5d) * Math.PI, Exponent);

...
public class SurfaceGGX : IOrientationProfile {
    ...
    public IProbabilityDistribution<Normal3> GetOrientations(Position3 position, Normal3 direction, IShape shape) => new SurfaceHalfEllipsoid(shape.OutwardsDirection(position), Roughness, direction);
}

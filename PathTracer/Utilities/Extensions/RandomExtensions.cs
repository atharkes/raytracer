...
public static class RandomExtensions {
    ...
    public static Vector3 Vector(this Random random, float scale = 1f) => new Vector3(random.NextSingle(), random.NextSingle(), random.NextSingle()) * scale;
    ...
    public static Unit3 Unit(this Random random) {
        ...
        return a < 1 / 6 ? Unit3.X : a < 2 / 6 ? Unit3.Y : a < 3 / 6 ? Unit3.Z : a < 4 / 6 ? Unit3.MinX : a < 5 / 6 ? Unit3.MinY : Unit3.MinZ;
    }
    ...
    public static IPrimitive Primitive(this Random random, float posRange = 1f, float scale = 1f) => new Primitive(random.Shape(posRange, scale), random.Material());
    ...
    public static IShape Shape(this Random random, float posRange = 1f, float scale = 1f) => random.NextDouble() < 0.5 ? random.CreateSphere(posRange, scale) : random.CreateTriangle(posRange, scale);
    ...
    public static Triangle CreateTriangle(this Random random, float posRange = 1f, float scale = 1f) {
        var pos = random.Vector(posRange);
    ...
    public static Sphere CreateSphere(this Random random, float posRange = 0f, float scale = 1f) => new(random.Vector(posRange), (float)random.NextDouble() * scale);
    ...
    public static IMaterial Material(this Random random) => random.NextDouble() < 0.9995f ? random.RandomNonEmitter() : random.RandomEmitter();
    ...
    public static IMaterial RandomNonEmitter(this Random random) {
        ...
        var specularity = random.NextDouble() < 0.3f ? (float)random.NextDouble() : 0;
        var roughness = random.NextDouble() < 0.5f ? (float)random.NextDouble() : 0;

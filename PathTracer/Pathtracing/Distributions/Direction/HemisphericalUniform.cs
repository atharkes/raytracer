...
public readonly struct HemisphericalUniform : IDirectionDistribution, IEquatable<HemisphericalUniform> {
    ...
    public Normal3 Sample(Random random) {
        ...
        var direction = ((Direction3)sphere.SurfacePosition(random)).Normalized();

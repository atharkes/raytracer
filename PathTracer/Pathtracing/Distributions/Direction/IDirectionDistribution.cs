...
namespace PathTracer.Pathtracing.Distributions.Direction {
    ...
    public interface IDirectionDistribution : IPDF<Normal3> {
        ...
        public static IDirectionDistribution? operator +(IDirectionDistribution? left, IDirectionDistribution? right) {
            return left is null ? right : (right is null ? left : throw new NotImplementedException());
        }
    }
}

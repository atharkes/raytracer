...
public interface IRay {
    ...
    Position3 Travel(Position1 distance) => Origin + Direction * distance;
    ...
    bool WithinBounds(Position1 distance) => 0 < distance && distance < Length;
    ...
    bool Enters(Normal3 normal) => IDirection3.Dot(Direction, normal) < 0;
    ...
    bool Exits(Normal3 normal) => IDirection3.Dot(Direction, normal) > 0;
}

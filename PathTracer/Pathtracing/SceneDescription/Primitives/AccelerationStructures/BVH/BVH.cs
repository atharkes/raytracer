...
namespace PathTracer.Pathtracing.AccelerationStructures.BVH {
    ...
    public class BVH : AccelerationStructure, IBinaryTree {
        ...
        public BVH(List<ISceneObject> primitives) {
        ...
        public (Shape Primitive, float Distance)? Intersect(Ray ray) {
        ...
        (Shape Primitive, float Distance)? IntersectChildren(Ray ray) {
            (Shape Primitive, float Distance)? firstIntersection;
            (Shape Primitive, float Distance)? secondIntersection;
        ...
        public bool IntersectBool(Ray ray) {
            if (!AABB.IntersectBool(ray)) {
                ...
                foreach (Shape primitive in AABB.SceneObjects) {

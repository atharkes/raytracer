...
public interface IReflectionProfile {
    static readonly IReflectionProfile Diffuse = new Diffuse();
    static readonly IReflectionProfile Specular = new Specular();
    static readonly IReflectionProfile Spherical = new Spherical();
    static IReflectionProfile Blend(params (IReflectionProfile profile, double weight)[] pairs) => new LinearBlend(pairs);

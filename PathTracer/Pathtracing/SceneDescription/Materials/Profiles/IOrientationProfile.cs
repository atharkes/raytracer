...
namespace PathTracer.Pathtracing.SceneDescription.Materials.Profiles {
    ...
    public interface IOrientationProfile {
        public static readonly IOrientationProfile Flat = new Flat();
        public static readonly IOrientationProfile Uniform = new Uniform();
        public static readonly IOrientationProfile Forwards = new Forwards();
        public static IOrientationProfile SurfaceGGX(float roughness) => new SurfaceGGX(roughness);
        public static IOrientationProfile SurfaceSGGX(float roughness) => new SurfaceSGGX(roughness);

...
namespace PathTracer.Pathtracing.AccelerationStructures.SBVH {
    ...
    public class PrimitiveFragment : Shape {
        /// <summary> The original <see cref="Shape"/> of the <see cref="PrimitiveFragment"/> </summary>
        public Shape Original { get; }
        ...
        public PrimitiveFragment(Shape original, Vector3[] bounds) {
            Original = original;
            Bounds = bounds;
